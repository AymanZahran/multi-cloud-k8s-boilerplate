...
for (const env of Object.values(Environment)) {
  ...
  new ManagementCluster(eksManagementApp, "management-eks-cluster", {
    ...
    environment: env,
    provider: "eks",
    ArgoCdHelmChartLabels: HelmChartLabels.argoCd[env],
    ArgoCdHelmChartsFlags: HelmChartFlags.argoCd[env],
    ArgoCdHelmChartVersion: HelmChartVersions.argoCd[env],
    ArgoCdHelmChartValues: HelmChartValues.argoCd[env],
